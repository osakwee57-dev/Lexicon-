...
const LOCAL_DICTIONARY: Record<Difficulty, WordEntry[]> = {
  ...
  Medium: [
    ...
    { word: "ZODIAC", definition: "A belt of the heavens within about 8° either side of the ecliptic, including all apparent positions of the sun, moon, and most familiar planets." },
            ...
            <>
              ...
              {gameState.status === 'won' ? (
                 <div className="controls">
                   <button className="btn btn-primary" onClick={fetchNewWord}>Next Word →</button>
                 </div>
              ) : (
